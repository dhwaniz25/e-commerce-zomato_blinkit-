...
const CheckOutPage = () => {
  ...
  console.log("Address List from Check Out", addressList);
  ...
  return (
    <section className="bg-blue-50">
      <div className="container mx-auto p-4 flex flex-col lg:flex-row w-full gap-5 justify-between cursor-pointer">
        ...
        <div className="w-full mx-w-md bg-white py-4 px-2">
          ...
          <div className="w-full flex flex-col gap-4">
            <button
              ...
              className="py-2 px-4 bg-green-500 hover:bg-green-700 rounded text-white font-semibold"
            >
              Online Payment
            </button>
            <button
