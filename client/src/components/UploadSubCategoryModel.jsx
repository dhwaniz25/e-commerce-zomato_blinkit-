...
const UploadSubCategoryModel = ({ close, fetchData }) => {
  ...
  console.log("Sub Category Data Name", subCategoryData);

  const handleRemoveCategorySelected = (categoryId) => {
    console.log("category Id in sub category", categoryId);
  ...
  const handleSubmitSubCategory = async (e) => {
    ...
    try {
      ...
      console.log("ResponseData from subCategory", responseData);
  ...
  return (
    <section className="fixed top-0 bottom-0 right-0 left-0 bg-neutral-800 bg-opacity-70 z-50 flex items-center justify-center">
      <div className="w-full max-w-5xl bg-white p-4 rounded">
        ...
        >
          ...
          {/* <div className="grid gap-1">
                      ...
                      <select name="" id="" className="bg-blue-50 p-3">
